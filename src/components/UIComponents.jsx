    ...
    if (this.state.hasError) {
      return (
        <div className="p-8 text-center flex flex-col items-center justify-center min-h-[50vh]">
          <div className="bg-red-50 p-6 rounded-xl border border-red-100 max-w-2xl w-full">
            ...
            <div className="text-left bg-white p-4 rounded-lg overflow-auto text-xs font-mono text-red-600 border border-red-200 mb-6 max-h-64">
              {this.state.error?.toString()}
              {this.state.error?.stack && (
                <div className="mt-2 pt-2 border-t border-red-100 text-slate-500">
                  {this.state.error.stack}
                </div>
              )}
            </div>
